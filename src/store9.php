...
<head>
    ...
    <title>Sephora - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Whether you're looking for the latest makeup trends, skincare essentials, or professional beauty tools, Sephora has everything you need to enhance your beauty routine and express your personal style.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store8"; // Change this to your MySQL database name
