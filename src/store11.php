...
<head>
    ...
    <title>Kitchen Accessories - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Whether you're a seasoned chef or just starting out, Kitchen Accessories has the products and expertise to help you create delicious meals and experiment with new recipes. Visit us today and discover the difference quality kitchen tools can make!</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store10"; // Change this to your MySQL database name
