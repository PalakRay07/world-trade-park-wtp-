...
<head>
    ...
    <title>Zara - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Visit our store at World Trade Park to explore our latest collections and find the perfect outfit for any occasion.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store1"; // Change this to your MySQL database name
