...
<head>
    ...
    <title>Grocery - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Whether you're planning a family dinner, hosting a party, or simply stocking up on pantry staples, Grocery store has everything you need to create flavorful and nutritious meals for you and your loved ones.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store9"; // Change this to your MySQL database name
