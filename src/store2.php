...
<head>
    ...
    <title>Forest Essentials - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Forest Essentials offers a range of luxurious Ayurvedic beauty and wellness products using traditional
            methods and natural ingredients.</p>
        <p>Explore our exquisite collection at World Trade Park and experience the purity and effectiveness of Ayurveda. </p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store2"; // Change this to your MySQL database name
