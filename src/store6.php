...
<head>
    ...
    <title>Cineplex - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Visit our theater at World Trade Park to enjoy a wide range of movies, from action-packed adventures to heartwarming dramas.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store6"; // Change this to your MySQL database name
