...
<head>
    ...
    <title>Mango - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Mango is a renowned fashion retailer offering trendy and chic clothing, accessories, and footwear for men and
            women.</p>
        <p>Explore our latest collections and find the perfect outfit for any occasion at Mango store in World Trade
            Park.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store3"; // Change this to your MySQL database name
