...
<head>
    ...
    <title>Home & Furniture - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Whether you're furnishing a new home or updating your current decor, Home & Furniture has the products and expertise to make your vision a reality. Visit us today and discover the latest trends in home design!</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store12"; // Change this to your MySQL database name
