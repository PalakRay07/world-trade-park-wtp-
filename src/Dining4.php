...
<head>
    ...
    <title>Baskin Robbins - World Trade Park</title>
    <style>
        body {
...
<body>
    ...
    <section id="restaurant-info">
        ...
        <p>Baskin Robbins is a global chain of ice cream parlors known for its wide range of flavors and innovative ice
            ...
            everyone, from classic favorites to seasonal specialties.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "dining4"; // Change this to your MySQL database name
