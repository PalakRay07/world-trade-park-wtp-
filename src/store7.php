...
<head>
    ...
    <title>Armani - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>With a focus on craftsmanship and innovation, Armani has become synonymous with luxury and style, attracting discerning customers worldwide.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store7"; // Change this to your MySQL database name
