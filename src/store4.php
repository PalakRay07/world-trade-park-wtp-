...
<head>
    ...
    <title>Puma - World Trade Park</title>
...
<body>
    ...
    <section id="store-info">
        ...
        <p>Puma is a leading sports and lifestyle brand that offers a wide range of athletic footwear, apparel, and
            accessories for men, women, and children. Known for its innovative designs, superior quality, and
            high-performance products, Puma is a favorite among athletes and fitness enthusiasts worldwide.</p>
        <p>With a commitment to sustainability and social responsibility, Puma strives to create products that not only
            enhance performance but also minimize environmental impact.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "store4"; // Change this to your MySQL database name
