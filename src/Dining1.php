...
<head>
    ...
    <title>Food Junction - World Trade Park</title>
    <style>
     body {
...
<body>
    ...
    <section id="restaurant-info">
        ...
        <p>Food Junction offers a wide variety of culinary delights, ranging from local delicacies to international
            ...
            delightful dining experience with friends and family.</p>
        ...
        $username = "root"; 
        $password = ""; 
        $database = "dining1"; // Change this to your MySQL database name
